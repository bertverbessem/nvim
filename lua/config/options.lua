...
vim.opt.spelllang = { "en", "nl" } -- Set language for spellchecking
...
vim.opt.winborder = "rounded" -- add border around floating windows
...
--- Set clipboard option (commented out, not using system clipboard by default)
vim.opt.clipboard = ""
